 ...
 * Page class
 */
class tbl_mahasiswa_view extends tbl_mahasiswa
{
	...
	// Page object name
	public $PageObjName = "tbl_mahasiswa_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tbl_mahasiswalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_mahasiswalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_mahasiswalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tbl_mahasiswalist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
