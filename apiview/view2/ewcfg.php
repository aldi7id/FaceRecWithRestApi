...
$CONFIG = [
	...
	"RANDOM_KEY" => 'cAeephSjUU9fi2p8', // Random key for encryption
	...
	"PROJECT_ID" => "{4851EE94-6D84-4603-B02D-4CE342AD52CB}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_kampus"]
	],
